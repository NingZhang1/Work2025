...
if __name__ == "__main__":
    ...
    bondlength = [1.68, 1.8, 1.9, 2.0, 2.2, 2.5, 2.8, 3.2]
    # bondlength = [1.68, 1.8, 1.9]
...
""" % (
        ...
        # fcidump.from_mo(Mol, DumpFileName, CASSCF_Driver.mo_coeff)

# 1.8 A CASSCF with iCI -2099.095103196893
# 1.8 A CASSCF          -2099.259771295132


## d2h 
# 1.8 A CASSCF          -2099.259771295132
# 1.8 A CASSCF with iCI -2099.2597713157056
